...
import model.roi_pooling_layer.roi_pooling_op as roi_pool_op
import model.roi_pooling_layer.roi_pooling_op_grad
from model.rpn_msr.proposal_layer_tf import proposal_layer as proposal_layer_py
from model.rpn_msr.anchor_target_layer_tf import anchor_target_layer as anchor_target_layer_py
from model.rpn_msr.proposal_target_layer_tf import proposal_target_layer as proposal_target_layer_py
    ...
    def fc(self, input, num_out, name, relu=True, trainable=True):
        with tf.variable_scope(name) as scope:
            ...
            if input_shape.ndims == 4:
                ...
                #print("dbg: input shape = ", input_shape)
